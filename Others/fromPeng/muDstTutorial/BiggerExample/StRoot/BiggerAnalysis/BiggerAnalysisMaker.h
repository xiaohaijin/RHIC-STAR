...
#ifndef BiggerAnalysisMaker_def
#define BiggerAnalysisMaker_def
...
class BiggerAnalysisMaker : public StMaker
{
 ...
 public:
  ...
  BiggerAnalysisMaker(StMuDstMaker* maker) ;       //  Constructor
  virtual          ~BiggerAnalysisMaker( ) ;       //  Destructor
  ...
  ClassDef(BiggerAnalysisMaker,1)                  //  Macro for CINT compatability
