// @(#)root/star:$Name: v2-25-03vp $:$Id: TDataSet.h,v 1.3 2000/09/29 18:17:48 fine Exp $
...
// $Id: TDataSet.h,v 1.3 2000/09/29 18:17:48 fine Exp $
...
inline TDataSet::TDataSet(TNode &){assert(0);}
