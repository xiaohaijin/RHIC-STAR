...
class StEEmcMixerMaker : public  StMaker {
 ...
 public: 
  ...
  virtual const char *GetCVS() const {static const char cvs[]="Tag $Name: SL18c $ $Id: StEEmcMixerMaker.h,v 1.4 2014/08/06 11:43:04 jeromel Exp $ built " __DATE__ " " __TIME__ ; return cvs;}
