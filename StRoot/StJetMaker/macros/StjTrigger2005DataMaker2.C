...
class StjTrigger2005DataMaker2 : public StMaker {

public:

  StjTrigger2005DataMaker2(const Char_t *name, TDirectory* file, StMuDstMaker* uDstMaker)
  : StMaker(name), _file(file), _uDstMaker(uDstMaker)
  { }

  virtual ~StjTrigger2005DataMaker2() { }

  const char* GetCVS() const
  {static const char cvs[]="Tag $Name: SL18c $ $Id: StjTrigger2005DataMaker2.C,v 1.3 2014/08/06 11:43:24 jeromel Exp $ built " __DATE__ " " __TIME__; return cvs;}
...
public:
  ...
  ClassDef(StjTrigger2005DataMaker2, 0)
