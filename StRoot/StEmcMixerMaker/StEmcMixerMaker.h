...
class StEmcMixerMaker : public StMaker 
{
  ...
  public: 
    ...
    virtual const char *GetCVS() const {static const char cvs[]="Tag $Name: SL18c $ $Id: StEmcMixerMaker.h,v 1.6 2014/08/06 11:43:05 jeromel Exp $ built " __DATE__ " " __TIME__ ; return cvs;}
