...
/*!
 ...
 @(#)StRoot/StBFChain:$Name: SL18c $:$Id: StBFChain.h,v 1.57 2016/05/17 12:05:33 jeromel Exp $
 ...
 public:
  ...
  void Setup(Int_t mode=1);
   ...
   virtual const char *GetCVS() const {
       static const char cvs[]="Tag $Name: SL18c $ $Id: StBFChain.h,v 1.57 2016/05/17 12:05:33 jeromel Exp $ built " __DATE__ " " __TIME__ ;
       return cvs;
   }
