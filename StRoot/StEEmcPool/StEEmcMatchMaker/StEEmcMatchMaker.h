...
class StEEmcMatchMaker : public StMaker 
{
  ...
  public: 
    ...
    virtual const char *GetCVS() const {static const char cvs[]="Tag $Name: SL18c $ $Id: StEEmcMatchMaker.h,v 1.2 2014/08/06 11:43:00 jeromel Exp $ built " __DATE__ " " __TIME__ ; return cvs;}
